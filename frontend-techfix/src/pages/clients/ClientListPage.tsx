                ...
                <tr key={client.id} className="border-b border-border last:border-0 hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-4 py-3 text-right">
                    <span className="inline-flex items-center gap-1 whitespace-nowrap">
                      <button onClick={() => openEdit(client.id)} className="p-1.5 hover:bg-primary/10 rounded-lg transition-colors group" title="Editar">
                      ...
                      {client.activo && (
                        <button onClick={() => handleDelete(client.id, `${client.nombre} ${client.apellido}`)} className="p-1.5 hover:bg-error/10 rounded-lg transition-colors group" title="Desactivar">
