...
export default function ServiceOrderListPage() {
  ...
  const downloadPdf = async (id: number) => {
    try {
      ...
      const res = await fetch(`http://127.0.0.1:8000/api/service-orders/${id}/pdf`, {
      ...
      a.href = url; a.download = `hoja-servicio-${id}.pdf`
