    ...
    <div className="max-w-5xl mx-auto mt-10 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <h2 className="text-2xl font-semibold text-foreground">Historial de Órdenes del Equipo</h2>
          {device && (
      ...
      {orders === null ? null : orders.length === 0 ? (
        <p className="text-muted-foreground">Este equipo no tiene órdenes registradas.</p>
      ) : (
